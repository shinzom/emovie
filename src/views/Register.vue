        ...
        <div class="main">
            ...
            <div class="loginbox">
                ...
                <div class="loginbox-in">
                    ...
                    <br>
                    <div class="pwdbox">
                        <svg t="1680522311002" viewBox="0 0 1024 1024" version="1.1"
                    ...
                    <div style="margin-top: 50px;display: flex;">
                        ...
                        <button style="font-size: 16px;color: #4E655D;margin-left: 20px;width: 50px;" 
                    class="register_btn" @click="login">登录</button>
                    </div>
                </div>

                <!-- 右侧的注册盒子 -->
                <div class="background">
                    <div class="title" @click="home">Welcome to eMovie</div>
                </div>
